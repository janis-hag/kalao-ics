...
def metaData():
    ...
    json_file = open(projectPath +
                     "/kalao/utils/database_definition_monitoring.json")
    ...
    projectPath = path.dirname(
            path.dirname(path.abspath(path.dirname(__file__))))
    json_file = open(projectPath +
                     "/kalao/utils/database_definition_obs_log.json")
    ...
    projectPath = path.dirname(
            path.dirname(path.abspath(path.dirname(__file__))))
    json_file = open(projectPath +
                     "/kalao/utils/database_definition_telemetry.json")
