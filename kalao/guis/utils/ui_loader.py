...
from kalao.guis.utils.widgets import (KChartView, KColorbar, KDateTimeEdit,
                                      KDraggableChartView, KGraphicsView,
                                      KLabel, KLineEdit, KNaNDoubleSpinbox,
                                      KScaledDoubleSpinbox, KStatusIndicator,
                                      KSvgWidget)

import config

uipath = config.kalao_ics_path / 'uis'
